...
class SpectralTransformer
{
    ...
    public:
        ...
        void differentiate(const vec_complex& in, vec_complex& out, real_t period=0);
        void lamIntegrate(const vec_complex& fk, vec_complex& out, complex_t lambda, real_t period=0);
        real_t interpolate(const vec_complex& fk, real_t x, real_t period=0);
        ...
        void solveInhom(const vec_real& f, const vec_real& g, vec_real& x, real_t period=0);
};